      ...
      <header className="w-full px-6 py-6 md:px-12 lg:px-20 bg-[#FAF7F2]">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 lg:gap-10 text-[11px] font-bold uppercase tracking-[0.2em] text-[#181716]/80">
            ...
            <Link href="/pricing" className="text-[#BE944E] border-b-2 border-[#BE944E] pb-0.5">BẢNG GIÁ</Link>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
          ...
          <div className="bg-white rounded-3xl p-8 border border-[#EFE9E1] shadow-2xs flex flex-col justify-between">
            <div>
              ...
              <div className="my-4">
                <span className="text-4xl font-serif font-bold text-[#181716]">0đ</span>
              </div>
              <p className="text-xs text-[#181716]/65 leading-relaxed mb-6">
                Trải nghiệm các tính năng cơ bản của thiệp mời số.
              </p>
              ...
              <div className="space-y-3 text-xs text-[#181716]/80 pt-4 border-t border-stone-100">
                <div className="flex items-start gap-2.5">
                  ...
                  <span>Mẫu thiệp cơ bản</span>
                </div>
                <div className="flex items-start gap-2.5">
                  <Check className="w-3.5 h-3.5 text-stone-400 mt-0.5 shrink-0" />
                  <span>Tùy chỉnh thông tin cơ bản</span>
                </div>
                <div className="flex items-start gap-2.5">
                  <Check className="w-3.5 h-3.5 text-stone-400 mt-0.5 shrink-0" />
                  <span>Thời gian sử dụng giới hạn</span>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-3xl p-8 border border-[#EFE9E1] shadow-2xs flex flex-col justify-between">
            <div>
              ...
              <div className="my-4">
                <span className="text-4xl font-serif font-bold text-[#181716]">199.000đ</span>
              </div>
              <p className="text-xs text-[#181716]/65 leading-relaxed mb-6">
                Tối ưu cho đám cưới và sự kiện cá nhân với các tiện ích nâng cao.
              </p>

              <div className="space-y-3 text-xs text-[#181716]/80 pt-4 border-t border-stone-100">
                <div className="flex items-start gap-2.5">
                  <Check className="w-3.5 h-3.5 text-stone-400 mt-0.5 shrink-0" />
                  <span>Nhạc nền MP3 tự chọn</span>
                </div>
                <div className="flex items-start gap-2.5">
                  <Check className="w-3.5 h-3.5 text-stone-400 mt-0.5 shrink-0" />
                  <span>Tích hợp VietQR mừng cưới</span>
                </div>
                <div className="flex items-start gap-2.5">
                  <Check className="w-3.5 h-3.5 text-stone-400 mt-0.5 shrink-0" />
                  <span>Link riêng cho từng khách (Individual links)</span>
                </div>
                <div className="flex items-start gap-2.5">
                  <Check className="w-3.5 h-3.5 text-stone-400 mt-0.5 shrink-0" />
                  <span>Lưu trữ vĩnh viễn (Permanent access)</span>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-3xl p-8 border-2 border-[#BE944E] shadow-xl relative flex flex-col justify-between overflow-hidden">
            ...
            <div className="pt-4">
              ...
              <div className="my-4">
                <span className="text-4xl font-serif font-bold text-[#181716]">249.000đ</span>
              </div>
              <p className="text-xs text-[#181716]/65 leading-relaxed mb-6">
                Trải nghiệm sang trọng tuyệt đối, thiết kế tinh xảo không tì vết.
              </p>

              <div className="space-y-3 text-xs text-[#181716]/80 pt-4 border-t border-stone-100">
                <div className="flex items-start gap-2.5">
                  <span className="text-sm">🗂️</span>
                  <span>Mọi tính năng của Tiêu Chuẩn</span>
                </div>
                <div className="flex items-start gap-2.5">
                  <span className="text-sm">⭐</span>
                  <span>Hiệu ứng 3D sáp niêm phong (Wax seal)</span>
                </div>
                <div className="flex items-start gap-2.5">
                  <span className="text-sm">🚫</span>
                  <span>Không có logo CardVite (White-label)</span>
                </div>
                <div className="flex items-start gap-2.5">
                  <span className="text-sm">📥</span>
                  <span>Xuất danh sách khách mời ra Excel</span>
                </div>
                <div className="flex items-start gap-2.5">
                  <span className="text-sm">🎧</span>
