  ...
  return (
    <div className="relative min-h-screen bg-[#F4F7F7] text-[#1E3E40] font-sans pb-28 sm:pb-32 overflow-x-hidden selection:bg-teal-200">
      <main className="w-full max-w-md sm:max-w-lg mx-auto bg-white shadow-[0_15px_60px_rgba(43,107,109,0.12)] sm:border-x border-[#D5E5E6] relative">
        ...
        <div className={`${isPreview ? "sticky" : "fixed"} bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-md border-t border-[#D5E5E6] px-3 pt-2.5 pb-[max(0.75rem,env(safe-area-inset-bottom))] shadow-xl flex items-center justify-center gap-2.5 max-w-md sm:max-w-lg mx-auto`}>
          <motion.button
