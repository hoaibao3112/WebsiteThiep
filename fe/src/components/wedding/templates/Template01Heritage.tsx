  ...
  return (
    <div className="relative min-h-screen bg-[#FFFDF9] text-stone-800 font-sans pb-28 sm:pb-32 overflow-x-hidden selection:bg-amber-200">
      ...
      <main className="w-full max-w-md sm:max-w-lg mx-auto bg-[#FFFDF9] shadow-[0_15px_60px_rgba(139,30,45,0.15)] sm:border-x border-[#E9D5BD] relative z-10">
        ...
        <div className={`${isPreview ? "sticky" : "fixed"} bottom-0 left-0 right-0 z-40 bg-[#8B1E2D]/95 backdrop-blur-md border-t-2 border-[#D4AF37] px-3 pt-2.5 pb-[max(0.75rem,env(safe-area-inset-bottom))] shadow-2xl flex items-center justify-center gap-2.5 max-w-md sm:max-w-lg mx-auto`}>
          <motion.button
