  ...
  return (
    <div className="relative min-h-screen bg-[#FAF8F5] text-[#3E2B22] font-serif pb-28 sm:pb-32 overflow-x-hidden selection:bg-[#EBDCD0]">
      <main className="w-full max-w-md sm:max-w-lg mx-auto bg-[#FAF8F5] shadow-[0_15px_60px_rgba(74,46,32,0.12)] sm:border-x border-[#EDE3D8] relative">
        ...
        <div className={`${isPreview ? "sticky" : "fixed"} bottom-0 left-0 right-0 z-40 bg-[#FAF8F5]/95 backdrop-blur-md border-t border-[#EDE3D8] px-3 pt-2.5 pb-[max(0.75rem,env(safe-area-inset-bottom))] shadow-lg flex items-center justify-center gap-2.5 max-w-md sm:max-w-lg mx-auto`}>
          <motion.button
