  ...
  return (
    <div className="relative min-h-screen bg-[#F7F2EB] text-[#2C1810] font-sans pb-28 sm:pb-32 overflow-x-hidden selection:bg-rose-200">
      <main className="w-full max-w-md sm:max-w-lg mx-auto bg-white shadow-[0_15px_60px_rgba(107,23,36,0.12)] sm:border-x border-[#EFE5D8] relative">
        ...
        <div className={`${isPreview ? "sticky" : "fixed"} bottom-0 left-0 right-0 z-40 bg-[#5C131F]/95 backdrop-blur-md border-t border-white/20 px-3 pt-2.5 pb-[max(0.75rem,env(safe-area-inset-bottom))] shadow-2xl flex items-center justify-center gap-2.5 max-w-md sm:max-w-lg mx-auto`}>
          <motion.button
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.96 }}
            onClick={onOpenRsvp}
