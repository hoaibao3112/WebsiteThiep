  ...
  return (
    <div className="relative min-h-screen bg-[#F4F7F4] text-[#1E3823] font-serif pb-28 sm:pb-32 overflow-x-hidden selection:bg-rose-200">
      <main className="w-full max-w-md sm:max-w-lg mx-auto bg-[#FCFDFC] shadow-[0_15px_60px_rgba(46,125,50,0.1)] sm:border-x border-[#DCE7DD] relative">
        ...
        <div className={`${isPreview ? "sticky" : "fixed"} bottom-0 left-0 right-0 z-40 bg-[#FCFDFC]/95 backdrop-blur-md border-t border-[#DCE7DD] px-3 pt-2.5 pb-[max(0.75rem,env(safe-area-inset-bottom))] shadow-lg flex items-center justify-center gap-2.5 max-w-md sm:max-w-lg mx-auto`}>
          <motion.button
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.96 }}
            onClick={onOpenRsvp}
