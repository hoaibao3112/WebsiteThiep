...
import { X, Mail, Lock, User, Phone, ArrowRight, CheckCircle2, AlertCircle, RefreshCw, Sparkles } from "lucide-react";
...
export function AuthModal() {
  ...
  const handleGoogleSignIn = () => {
    // Demo / Google GIS Trigger
    // Khi người dùng tích hợp GOOGLE_CLIENT_ID, Google One-Tap hoặc Popup sẽ cung cấp idToken
    const dummyGoogleToken = "google-id-token-placeholder";
    googleLogin(dummyGoogleToken).catch((err) => {
      setErrorMessage("Đang mở cửa sổ đăng nhập Google...");
    });
  };
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 text-xs rounded-xl bg-white border border-[#E8E2D8] focus:outline-none focus:ring-2 focus:ring-[#BE944E]/40 text-stone-900"
                  />
                </div>
              </div>
